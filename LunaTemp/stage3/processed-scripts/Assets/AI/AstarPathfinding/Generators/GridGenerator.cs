...
namespace Pathfinding {
	...
	public class GridGraph : NavGraph, IUpdatableGraph, ITransformedGraph
		...
		public override void RelocateNodes ([Bridge.Ref] Matrix4x4 deltaMatrix) {
		...
		/// </summary>
		public void RelocateNodes ([Bridge.Ref] Vector3 center, [Bridge.Ref] Quaternion rotation, float nodeSize, float aspectRatio = 1, float isometricAngle = 0) {
		...
		/// </summary>
		public override bool IsInsideBounds ([Bridge.Ref] Vector3 point) {
		...
		public override NNInfoInternal GetNearest ([Bridge.Ref] Vector3 position, NNConstraint constraint, GraphNode hint) {
		...
		protected virtual GridNodeBase GetNearestFromGraphSpace ([Bridge.Ref] Vector3 positionGraphSpace) {
			if (nodes == null || depth*width != nodes.Length) {
				return null;
			}
		...
		public override NNInfoInternal GetNearestForce ([Bridge.Ref] Vector3 position, NNConstraint constraint) {
		...
		/// </summary>
		public IntRect GetRectFromBounds ([Bridge.Ref] Bounds bounds) {
		...
		public List<GraphNode> GetNodesInArea ([Bridge.Ref] Bounds bounds) {
		...
		/// <summary>Deprecated: This method has been renamed to GetNodesInRegion</summary>
		[System.Obsolete("This method has been renamed to GetNodesInRegion", true)]
		public List<GraphNode> GetNodesInArea ([Bridge.Ref] Bounds bounds, GraphUpdateShape shape) {
		...
		/// </summary>
		public List<GraphNode> GetNodesInRegion ([Bridge.Ref] Bounds bounds) {
		...
		/// </summary>
		public bool Linecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to) {
			GraphHitInfo hit;
		...
		public bool Linecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to, GraphNode hint) {
			GraphHitInfo hit;
		...
		/// <param name="hint">This parameter is deprecated. It will be ignored.</param>
		[System.Obsolete("The hint parameter is deprecated")]
		public bool Linecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to, GraphNode hint, out GraphHitInfo hit) {
			return Linecast(from, to, hint, out hit, null);
		}

		/// <summary>Magnitude of the cross product a x b</summary>
		protected static long CrossMagnitude ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b) {
		...
		/// </summary>
		protected bool ClipLineSegmentToBounds ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, out Vector3 outA, out Vector3 outB) {
		...
		[System.Obsolete("The hint parameter is deprecated")]
		public bool Linecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to, GraphNode hint, out GraphHitInfo hit, List<GraphNode> trace) {
		...
		public bool Linecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to, out GraphHitInfo hit, List<GraphNode> trace = null, System.Func<GraphNode, bool> filter = null) {
			GridHitInfo gridHit;
		...
		public bool SnappedLinecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to, GraphNode hint, out GraphHitInfo hit) {
			return Linecast(
		...
		/// <param name="filter">If not null then the delegate will be called for each node and if it returns false the node will be treated as unwalkable and a hit will be returned.
		///               Note that unwalkable nodes are always treated as unwalkable regardless of what this filter returns.</param>
		public bool Linecast ([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to, out GridHitInfo hit, List<GraphNode> trace = null, System.Func<GraphNode, bool> filter = null) {
			Vector3 fromInGraphSpace = transform.InverseTransform(from);
			Vector3 toInGraphSpace = transform.InverseTransform(to);
		...
		public bool Linecast (GridNodeBase fromNode, [Bridge.Ref] Vector2 normalizedFromPoint, GridNodeBase toNode, [Bridge.Ref] Vector2 normalizedToPoint, out GridHitInfo hit, List<GraphNode> trace = null, System.Func<GraphNode, bool> filter = null, bool continuePastEnd = false) {
