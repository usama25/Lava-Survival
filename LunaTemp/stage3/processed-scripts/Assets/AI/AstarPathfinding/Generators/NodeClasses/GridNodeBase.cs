...
namespace Pathfinding {
	...
	public abstract class GridNodeBase : GraphNode {
		...
		/// </code>
		/// </summary>
		public override bool ContainsPoint ([Bridge.Ref] Vector3 point) {
		...
		/// </summary>
		public override bool ContainsPointInGraphSpace ([Bridge.Ref] Int3 point) {
		...
		/// </summary>
		public Vector2 NormalizePoint ([Bridge.Ref] Vector3 worldPoint) {
			GridGraph gg = GridNode.GetGridGraph(GraphIndex);
		...
		/// </summary>
		public Vector3 UnNormalizePoint ([Bridge.Ref] Vector2 normalizedPointOnSurface) {
			GridGraph gg = GridNode.GetGridGraph(GraphIndex);
