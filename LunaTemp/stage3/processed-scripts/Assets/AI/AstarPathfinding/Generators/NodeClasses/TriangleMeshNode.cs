...
namespace Pathfinding {
	...
	public class TriangleMeshNode : MeshNode {
		...
		/// </summary>
		internal Int3 ClosestPointOnNodeXZInGraphSpace ([Bridge.Ref] Vector3 p) {
		...
		public override Vector3 ClosestPointOnNodeXZ ([Bridge.Ref] Vector3 p) {
		...
		/// </code>
		/// </summary>
		public override bool ContainsPoint ([Bridge.Ref] Vector3 p) {
		...
		/// </summary>
		public override bool ContainsPointInGraphSpace ([Bridge.Ref] Int3 p) {
			// Get all 3 vertices for this node
			Int3 a, b, c;
