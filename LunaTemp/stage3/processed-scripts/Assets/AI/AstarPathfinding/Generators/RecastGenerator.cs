...
namespace Pathfinding {
	...
	public class RecastGraph : NavmeshBase, IUpdatableGraph {
		...
		public Vector3 ClosestPointOnNode (TriangleMeshNode node, [Bridge.Ref] Vector3 pos) {
		...
		public bool ContainsPoint (TriangleMeshNode node, [Bridge.Ref] Vector3 pos) {
		...
		List<RasterizationMesh> CollectMeshes ([Bridge.Ref] Bounds bounds) {
		...
		/// </summary>
		NavmeshTile CreateTile (Voxelize vox, [Bridge.Ref] VoxelMesh mesh, int x, int z, int threadIndex) {
