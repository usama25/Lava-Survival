...
namespace Pathfinding.Util {
	...
	public class GridLookup<T> where T : class {
		...
		/// </summary>
		public Root Add (T item, [Bridge.Ref] IntRect bounds) {
			var root = new Root {
				obj = item,
				prev = all,
				next = all.next
		...
		public void Move (T item, [Bridge.Ref] IntRect bounds) {
			Root root;
		...
		/// </summary>
		public List<U> QueryRect<U>([Bridge.Ref] IntRect r) where U : class, T {
