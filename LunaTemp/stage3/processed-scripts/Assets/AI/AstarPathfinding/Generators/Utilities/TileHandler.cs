...
namespace Pathfinding.Util {
	...
	public class TileHandler {
		...
		/// </summary>
		public int GetActiveRotation ([Bridge.Ref] Int2 p) {
		...
		public TileType RegisterTileType (Mesh source, [Bridge.Ref] Int3 centerOffset, int width = 1, int depth = 1) {
		...
		int ClipAgainstRectangle (Int3[] clipIn, Int3[] clipOut, [Bridge.Ref] Int2 size) {
			int ct;
		...
		public void ReloadInBounds ([Bridge.Ref] Bounds bounds) {
