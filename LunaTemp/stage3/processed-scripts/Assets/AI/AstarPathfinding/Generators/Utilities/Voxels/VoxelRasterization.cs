...
namespace Pathfinding.Voxels {
	...
	public partial class Voxelize {
		...
		public void VectorToIndex ([Bridge.Ref] Vector3 p, out int x, out int z) {
			p -= voxelOffset;
		...
		public void VoxelizeInput (Pathfinding.Util.GraphTransform graphTransform, [Bridge.Ref] Bounds graphSpaceBounds) {
		...
		void DrawLine (int a, int b, int[] indices, int[] verts, [Bridge.Ref] Color color) {
		...
		/// (1,0,0) is one voxel in the +X direction of that.
		/// </summary>
		public Int3 VoxelToWorldInt3 ([Bridge.Ref] Int3 voxelPosition) {
