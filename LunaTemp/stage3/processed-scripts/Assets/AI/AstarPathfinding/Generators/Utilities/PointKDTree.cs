...
namespace Pathfinding {
	...
	public class PointKDTree {
		...
		public GraphNode GetNearest ([Bridge.Ref] Int3 point, NNConstraint constraint) {
			GraphNode best = null;
		...
		void GetNearestInternal (int index, [Bridge.Ref] Int3 point, NNConstraint constraint, ref GraphNode best, ref long bestSqrDist) {
		...
		/// <summary>Closest node to the point which satisfies the constraint</summary>
		public GraphNode GetNearestConnection ([Bridge.Ref] Int3 point, NNConstraint constraint, long maximumSqrConnectionLength) {
			GraphNode best = null;
			long bestSqrDist = long.MaxValue;
		...
		void GetNearestConnectionInternal (int index, [Bridge.Ref] Int3 point, NNConstraint constraint, ref GraphNode best, ref long bestSqrDist, long distanceThresholdOffset) {
			var data = tree[index].data;
		...
		public void GetInRange ([Bridge.Ref] Int3 point, long sqrRadius, List<GraphNode> buffer) {
			GetInRangeInternal(1, point, sqrRadius, buffer);
		}

		void GetInRangeInternal (int index, [Bridge.Ref] Int3 point, long sqrRadius, List<GraphNode> buffer) {
			var data = tree[index].data;
