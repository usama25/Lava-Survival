...
namespace Pathfinding {
	...
	public class PointGraph : NavGraph
		...
		NNInfoInternal GetNearestInternal ([Bridge.Ref] Vector3 position, NNConstraint constraint, bool fastCheck) {
		...
		NNInfoInternal FindClosestConnectionPoint (PointNode node, [Bridge.Ref] Vector3 position) {
		...
		/// </summary>
		public PointNode AddNode ([Bridge.Ref] Int3 position) {
		...
		public T AddNode<T>(T node, [Bridge.Ref] Int3 position) where T : PointNode {
