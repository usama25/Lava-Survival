...
namespace Pathfinding {
	...
	public class RadiusModifier : MonoModifier {
		...
		bool CalculateCircleInner ([Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, float r1, float r2, out float a, out float sigma) {
		...
		/// <param name="a">Angle from the line joining the centers of the circles to the inner tangents.</param>
		/// <param name="sigma">World angle from p1 to p2 (in XZ space)</param>
		bool CalculateCircleOuter ([Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, float r1, float r2, out float a, out float sigma) {
			float dist = (p1-p2).magnitude;
		...
		TangentType CalculateTangentType ([Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3, [Bridge.Ref] Vector3 p4) {
		...
		TangentType CalculateTangentTypeSimple ([Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3) {
