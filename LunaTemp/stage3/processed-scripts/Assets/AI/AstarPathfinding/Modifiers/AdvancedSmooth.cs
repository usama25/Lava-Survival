...
namespace Pathfinding {
	...
	public class AdvancedSmooth : MonoModifier {
		...
		public class MaxTurn : TurnConstructor {
			...
			public override void GetPath ([Bridge.Ref] Turn turn, List<Vector3> output) {
				switch (turn.id) {
				case 0:
		...
		public abstract class TurnConstructor {
			...
			public void AddCircleSegment (double startAngle, double endAngle, bool clockwise, [Bridge.Ref] Vector3 center, List<Vector3> output, float radius) {
			...
			public void DebugCircleSegment ([Bridge.Ref] Vector3 center, double startAngle, double endAngle, double radius, [Bridge.Ref] Color color) {
				double step = ThreeSixtyRadians / 100;
			...
			public void DebugCircle ([Bridge.Ref] Vector3 center, double radius, [Bridge.Ref] Color color) {
				double step = ThreeSixtyRadians / 100;
			...
			public double Atan2 ([Bridge.Ref] Vector3 v) {
		...
		public struct Turn : IComparable<Turn> {
			...
			public int CompareTo ([Bridge.Ref] Turn t) {
