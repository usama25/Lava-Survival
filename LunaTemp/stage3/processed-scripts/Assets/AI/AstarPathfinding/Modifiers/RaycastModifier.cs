...
namespace Pathfinding {
	...
	public class RaycastModifier : MonoModifier {
		...
		/// </summary>
		protected bool ValidateLine (GraphNode n1, GraphNode n2, [Bridge.Ref] Vector3 v1, [Bridge.Ref] Vector3 v2, System.Func<GraphNode, bool> filter, NNConstraint nnConstraint) {
			if (useRaycasting) {
