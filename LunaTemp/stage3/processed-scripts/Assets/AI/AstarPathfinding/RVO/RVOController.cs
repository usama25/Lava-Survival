...
namespace Pathfinding.RVO {
	...
	public class RVOController : VersionedMonoBehaviour {
		...
		/// <param name="deltaTime">How far to move [seconds].
		///      Usually set to Time.deltaTime.</param>
		public Vector3 CalculateMovementDelta ([Bridge.Ref] Vector3 position, float deltaTime) {
		...
		public void SetCollisionNormal ([Bridge.Ref] Vector3 normal) {
		...
		public void ForceSetVelocity ([Bridge.Ref] Vector3 velocity) {
		...
		/// </summary>
		public Vector2 To2D ([Bridge.Ref] Vector3 p) {
			float dummy;
		...
		/// </summary>
		public Vector2 To2D ([Bridge.Ref] Vector3 p, out float elevation) {
		...
		/// See: movementPlane
		/// </summary>
		public Vector3 To3D ([Bridge.Ref] Vector2 p, float elevationCoordinate) {
			if (movementPlane == MovementPlane.XY) {
		...
		public void SetTarget ([Bridge.Ref] Vector3 pos, float speed, float maxSpeed) {
			if (simulator == null) return;
		...
		/// </summary>
		public void Move ([Bridge.Ref] Vector3 vel) {
			if (simulator == null) return;
		...
		public void Teleport ([Bridge.Ref] Vector3 pos) {
			tr.position = pos;
		}
