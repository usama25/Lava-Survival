...
namespace Pathfinding.RVO {
	...
	public class RVOQuadtree {
		...
		struct Node {
			...
			/// </summary>
			public void Distribute (Node[] nodes, [Bridge.Ref] Rect r) {
				Vector2 c = r.center;
		...
		public void SetBounds ([Bridge.Ref] Rect r) {
			bounds = r;
		}
		...
		public void Query ([Bridge.Ref] Vector2 p, float speed, float timeHorizon, float agentRadius, Agent agent) {
			new QuadtreeQuery {
		...
		struct QuadtreeQuery {
			...
			public void QueryRec (int i, [Bridge.Ref] Rect r) {
		...
		void DebugDrawRec (int i, [Bridge.Ref] Rect r) {
