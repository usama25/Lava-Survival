...
namespace Pathfinding.RVO {
	...
	public class Simulator {
		...
		public IAgent AddAgent ([Bridge.Ref] Vector3 position) {
		...
		public IAgent AddAgent ([Bridge.Ref] Vector2 position, float elevationCoordinate) {
		...
		/// See: RemoveObstacle
		/// </summary>
		public ObstacleVertex AddObstacle (Vector3[] vertices, float height, [Bridge.Ref] Matrix4x4 matrix, RVOLayer layer = RVOLayer.DefaultObstacle, bool cycle = true) {
		...
		/// See: RemoveObstacle
		/// </summary>
		public ObstacleVertex AddObstacle ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, float height) {
