...
namespace Pathfinding.RVO.Sampled {
	...
	public class Agent : IAgent {
		...
		public void SetTarget ([Bridge.Ref] Vector2 targetPoint, float desiredSpeed, float maxSpeed) {
		...
		public void SetCollisionNormal ([Bridge.Ref] Vector2 normal) {
			collisionNormal = normal;
		}

		/// <summary>\copydoc Pathfinding::RVO::IAgent::ForceSetVelocity</summary>
		public void ForceSetVelocity ([Bridge.Ref] Vector2 velocity) {
		...
		static Vector3 FromXZ ([Bridge.Ref] Vector2 p) {
			return new Vector3(p.x, 0, p.y);
		}

		/// <summary>(x, z)</summary>
		static Vector2 ToXZ ([Bridge.Ref] Vector3 p) {
		...
		/// </summary>
		Vector2 To2D ([Bridge.Ref] Vector3 p, out float elevation) {
		...
		static void DrawVO ([Bridge.Ref] Vector2 circleCenter, float radius, [Bridge.Ref] Vector2 origin) {
		...
		internal struct VO {
			...
			/// </summary>
			public static VO SegmentObstacle ([Bridge.Ref] Vector2 segmentStart, [Bridge.Ref] Vector2 segmentEnd, [Bridge.Ref] Vector2 offset, float radius, float inverseDt, float inverseDeltaTime) {
				var vo = new VO();
			...
			/// </summary>
			public static float SignedDistanceFromLine ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 dir, [Bridge.Ref] Vector2 p) {
			...
			/// </summary>
			public Vector2 ScaledGradient ([Bridge.Ref] Vector2 p, out float weight) {
			...
			/// </summary>
			public Vector2 Gradient ([Bridge.Ref] Vector2 p, out float weight) {
				if (colliding) {
		...
		internal class VOBuffer {
			...
			public void Add ([Bridge.Ref] VO vo) {
		...
		Vector2 GradientDescent (VOBuffer vos, [Bridge.Ref] Vector2 sampleAround1, [Bridge.Ref] Vector2 sampleAround2) {
			float score1;
		...
		Vector2 EvaluateGradient (VOBuffer vos, [Bridge.Ref] Vector2 p, out float value) {
