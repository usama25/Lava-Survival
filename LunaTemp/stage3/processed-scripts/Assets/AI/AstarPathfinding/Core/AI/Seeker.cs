...
namespace Pathfinding {
	...
	public class Seeker : VersionedMonoBehaviour {
		...
		public ABPath GetNewPath ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end) {
		...
		public Path StartPath ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end) {
		...
		public Path StartPath ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, OnPathDelegate callback) {
		...
		public Path StartPath ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, OnPathDelegate callback, [Bridge.Ref] GraphMask graphMask) {
		...
		public Path StartPath (Path p, OnPathDelegate callback, [Bridge.Ref] GraphMask graphMask) {
		...
		public MultiTargetPath StartMultiTargetPath ([Bridge.Ref] Vector3 start, Vector3[] endPoints, bool pathsForAll, OnPathDelegate callback = null, int graphMask = -1) {
		...
		/// <param name="callback">The function to call when the path has been calculated</param>
		/// <param name="graphMask">Mask used to specify which graphs should be searched for close nodes. See Pathfinding.NNConstraint.graphMask.</param>
		public MultiTargetPath StartMultiTargetPath (Vector3[] startPoints, [Bridge.Ref] Vector3 end, bool pathsForAll, OnPathDelegate callback = null, int graphMask = -1) {
