...
namespace Pathfinding {
	...
	public class AILerp : VersionedMonoBehaviour, IAstarAI {
		...
		void IAstarAI.Move ([Bridge.Ref] Vector3 deltaPosition) {
		...
		public void Teleport ([Bridge.Ref] Vector3 position, bool clearPath = true) {
		...
		public void FinalizeMovement ([Bridge.Ref] Vector3 nextPosition, [Bridge.Ref] Quaternion nextRotation) {
		...
		Quaternion SimulateRotationTowards ([Bridge.Ref] Vector3 direction, float deltaTime) {
