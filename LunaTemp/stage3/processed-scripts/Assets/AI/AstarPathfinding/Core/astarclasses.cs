...
namespace Pathfinding {
	...
	public class AstarColor : ISerializationCallbackReceiver {
		...
		public void OnAfterDeserialize () {
			...
			if (_AreaColors != null && _AreaColors.Length == 1 && _AreaColors[0] == default(UnityEngine.Color)) {
	...
	public struct IntRect {
		...
		/// See: IsValid
		/// </summary>
		public static IntRect Intersection ([Bridge.Ref] IntRect a, [Bridge.Ref] IntRect b) {
			return new IntRect(
		...
		public static bool Intersects ([Bridge.Ref] IntRect a, [Bridge.Ref] IntRect b) {
		...
		/// </summary>
		public static IntRect Union ([Bridge.Ref] IntRect a, [Bridge.Ref] IntRect b) {
			return new IntRect(
		...
		public void DebugDraw (GraphTransform transform, [Bridge.Ref] Color color) {
