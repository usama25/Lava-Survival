...
public class AstarPath : VersionedMonoBehaviour {
	...
	/// </summary>
	public void AddWorkItem ([Bridge.Ref] AstarWorkItem item) {
	...
	/// See: graph-updates (view in online documentation for working links)
	/// </summary>
	public void UpdateGraphs ([Bridge.Ref] Bounds bounds, float delay) {
	...
	/// See: graph-updates (view in online documentation for working links)
	/// </summary>
	public void UpdateGraphs ([Bridge.Ref] Bounds bounds) {
		UpdateGraphs(new GraphUpdateObject(bounds));
	}
	...
	/// </summary>
	public NNInfo GetNearest ([Bridge.Ref] Vector3 position) {
	...
	/// See: Pathfinding.NNConstraint
	/// </summary>
	public NNInfo GetNearest ([Bridge.Ref] Vector3 position, NNConstraint constraint) {
	...
	/// See: Pathfinding.NNConstraint
	/// </summary>
	public NNInfo GetNearest ([Bridge.Ref] Vector3 position, NNConstraint constraint, GraphNode hint) {
...
#pragma warning restore 0618
	...
	/// </summary>
	public GraphNode GetNearest ([Bridge.Ref] Ray ray) {
