...
namespace Pathfinding {
	...
	public class GraphUpdateShape {
		...
		static Bounds GetBounds (Vector3[] points, [Bridge.Ref] Vector3 right, [Bridge.Ref] Vector3 up, [Bridge.Ref] Vector3 forward, [Bridge.Ref] Vector3 origin, float minimumHeight) {
