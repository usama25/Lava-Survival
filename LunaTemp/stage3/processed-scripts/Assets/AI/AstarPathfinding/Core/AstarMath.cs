...
namespace Pathfinding {
	...
	public static class AstarSplines {
		public static Vector3 CatmullRom ([Bridge.Ref] Vector3 previous, [Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, [Bridge.Ref] Vector3 next, float elapsedTime) {
			// References used:
			// p.266 GemsV1
			//
		...
		public static Vector3 CubicBezier ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3, float t) {
			t = Mathf.Clamp01(t);
			float t2 = 1-t;
		...
		public static Vector3 CubicBezierDerivative ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3, float t) {
			t = Mathf.Clamp01(t);
			float t2 = 1-t;
		...
		public static Vector3 CubicBezierSecondDerivative ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3, float t) {
			t = Mathf.Clamp01(t);
			float t2 = 1-t;
	...
	public static class VectorMath {
		...
		/// </summary>
		public static Vector2 ComplexMultiply ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b) {
		...
		/// </summary>
		public static Vector2 ComplexMultiplyConjugate ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b) {
		...
		/// </summary>
		public static Vector3 ClosestPointOnLine ([Bridge.Ref] Vector3 lineStart, [Bridge.Ref] Vector3 lineEnd, [Bridge.Ref] Vector3 point) {
		...
		/// See: ClosestPointOnSegment
		/// </summary>
		public static float ClosestPointOnLineFactor ([Bridge.Ref] Vector3 lineStart, [Bridge.Ref] Vector3 lineEnd, [Bridge.Ref] Vector3 point) {
		...
		/// The closest point can be calculated using (end-start)*factor + start
		/// </summary>
		public static float ClosestPointOnLineFactor ([Bridge.Ref] Int3 lineStart, [Bridge.Ref] Int3 lineEnd, [Bridge.Ref] Int3 point) {
		...
		/// The closest point can be calculated using (end-start)*factor + start;
		/// </summary>
		public static float ClosestPointOnLineFactor ([Bridge.Ref] Int2 lineStart, [Bridge.Ref] Int2 lineEnd, [Bridge.Ref] Int2 point) {
			var lineDirection = lineEnd - lineStart;
		...
		/// </summary>
		public static Vector3 ClosestPointOnSegment ([Bridge.Ref] Vector3 lineStart, [Bridge.Ref] Vector3 lineEnd, [Bridge.Ref] Vector3 point) {
			var dir = lineEnd - lineStart;
			float sqrMagn = dir.sqrMagnitude;
		...
		/// TODO: Is this actually approximate? It looks exact.
		/// </summary>
		public static float SqrDistancePointSegmentApproximate ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 p) {
		...
		/// </summary>
		public static float SqrDistancePointSegment ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 p) {
		...
		/// </summary>
		public static float SqrDistanceSegmentSegment ([Bridge.Ref] Vector3 s1, [Bridge.Ref] Vector3 e1, [Bridge.Ref] Vector3 s2, [Bridge.Ref] Vector3 e2) {
			Vector3 dir1 = e1 - s1;
			Vector3 dir2 = e2 - s2;
		...
		public static float SqrDistanceXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b) {
			var delta = a-b;
		...
		/// </summary>
		public static long SignedTriangleAreaTimes2XZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 c) {
		...
		/// This will be negative for clockwise triangles and positive for counter-clockwise ones.
		/// </summary>
		public static float SignedTriangleAreaTimes2XZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c) {
		...
		/// </summary>
		public static bool RightXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 p) {
		...
		/// Uses XZ space. Does not return true if the points are colinear.
		/// </summary>
		public static bool RightXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 p) {
		...
		/// Uses XZ space.
		/// </summary>
		public static Side SideXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 p) {
		...
		/// </summary>
		public static bool RightOrColinear ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b, [Bridge.Ref] Vector2 p) {
		...
		/// Also returns true if the points are colinear.
		/// </summary>
		public static bool RightOrColinear ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b, [Bridge.Ref] Int2 p) {
		...
		/// </summary>
		public static bool RightOrColinearXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 p) {
		...
		/// Uses XZ space. Also returns true if the points are colinear.
		/// </summary>
		public static bool RightOrColinearXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 p) {
			return (long)(b.x - a.x) * (long)(p.z - a.z) - (long)(p.x - a.x) * (long)(b.z - a.z) <= 0;
		}
		...
		/// </summary>
		public static bool IsClockwiseMarginXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c) {
			return (b.x-a.x)*(c.z-a.z)-(c.x-a.x)*(b.z-a.z) <= float.Epsilon;
		}

		/// <summary>Returns if the points a in a clockwise order</summary>
		public static bool IsClockwiseXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c) {
			return (b.x-a.x)*(c.z-a.z)-(c.x-a.x)*(b.z-a.z) < 0;
		}

		/// <summary>Returns if the points a in a clockwise order</summary>
		public static bool IsClockwiseXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 c) {
			return RightXZ(a, b, c);
		}

		/// <summary>Returns true if the points a in a clockwise order or if they are colinear</summary>
		public static bool IsClockwiseOrColinearXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 c) {
			return RightOrColinearXZ(a, b, c);
		}

		/// <summary>Returns true if the points a in a clockwise order or if they are colinear</summary>
		public static bool IsClockwiseOrColinear ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b, [Bridge.Ref] Int2 c) {
			return RightOrColinear(a, b, c);
		}

		/// <summary>Returns if the points are colinear (lie on a straight line)</summary>
		public static bool IsColinear ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c) {
			var lhs = b - a;
			var rhs = c - a;
		...
		/// <summary>Returns if the points are colinear (lie on a straight line)</summary>
		public static bool IsColinear ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b, [Bridge.Ref] Vector2 c) {
		...
		/// <summary>Returns if the points are colinear (lie on a straight line)</summary>
		public static bool IsColinearXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 c) {
			return (long)(b.x - a.x) * (long)(c.z - a.z) - (long)(c.x - a.x) * (long)(b.z - a.z) == 0;
		}

		/// <summary>Returns if the points are colinear (lie on a straight line)</summary>
		public static bool IsColinearXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c) {
		...
		/// <summary>Returns if the points are colinear (lie on a straight line)</summary>
		public static bool IsColinearAlmostXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 c) {
		...
		/// </summary>
		public static bool SegmentsIntersect ([Bridge.Ref] Int2 start1, [Bridge.Ref] Int2 end1, [Bridge.Ref] Int2 start2, [Bridge.Ref] Int2 end2) {
		...
		/// Note: XZ space
		/// </summary>
		public static bool SegmentsIntersectXZ ([Bridge.Ref] Int3 start1, [Bridge.Ref] Int3 end1, [Bridge.Ref] Int3 start2, [Bridge.Ref] Int3 end2) {
		...
		/// </summary>
		public static bool SegmentsIntersectXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 end1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 end2) {
		...
		/// </summary>
		public static bool LineLineIntersectionFactor ([Bridge.Ref] Vector2 start1, [Bridge.Ref] Vector2 dir1, [Bridge.Ref] Vector2 start2, [Bridge.Ref] Vector2 dir2, out float t) {
		...
		/// </summary>
		public static Vector3 LineDirIntersectionPointXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 dir1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 dir2) {
			float den = dir2.z*dir1.x - dir2.x * dir1.z;
		...
		/// See: LineIntersectionPointXZ
		/// </summary>
		public static Vector3 LineDirIntersectionPointXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 dir1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 dir2, out bool intersects) {
			float den = dir2.z*dir1.x - dir2.x * dir1.z;
		...
		/// </summary>
		public static bool RaySegmentIntersectXZ ([Bridge.Ref] Int3 start1, [Bridge.Ref] Int3 end1, [Bridge.Ref] Int3 start2, [Bridge.Ref] Int3 end2) {
		...
		/// Only the XZ coordinates are used.
		/// </summary>
		public static bool LineIntersectionFactorXZ ([Bridge.Ref] Int3 start1, [Bridge.Ref] Int3 end1, [Bridge.Ref] Int3 start2, [Bridge.Ref] Int3 end2, out float factor1, out float factor2) {
			Int3 dir1 = end1-start1;
			Int3 dir2 = end2-start2;
		...
		/// Only the XZ coordinates are used.
		/// </summary>
		public static bool LineIntersectionFactorXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 end1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 end2, out float factor1, out float factor2) {
			Vector3 dir1 = end1-start1;
			Vector3 dir2 = end2-start2;
		...
		/// </summary>
		public static float LineRayIntersectionFactorXZ ([Bridge.Ref] Int3 start1, [Bridge.Ref] Int3 end1, [Bridge.Ref] Int3 start2, [Bridge.Ref] Int3 end2) {
			Int3 dir1 = end1-start1;
			Int3 dir2 = end2-start2;
		...
		/// </summary>
		public static float LineIntersectionFactorXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 end1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 end2) {
			Vector3 dir1 = end1-start1;
			Vector3 dir2 = end2-start2;
		...
		public static Vector3 LineIntersectionPointXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 end1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 end2) {
			bool s;
		...
		/// <summary>Returns the intersection point between the two lines. Lines are treated as infinite. start1 is returned if the lines are parallel</summary>
		public static Vector3 LineIntersectionPointXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 end1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 end2, out bool intersects) {
			Vector3 dir1 = end1-start1;
			Vector3 dir2 = end2-start2;
		...
		/// <summary>Returns the intersection point between the two lines. Lines are treated as infinite. start1 is returned if the lines are parallel</summary>
		public static Vector2 LineIntersectionPoint ([Bridge.Ref] Vector2 start1, [Bridge.Ref] Vector2 end1, [Bridge.Ref] Vector2 start2, [Bridge.Ref] Vector2 end2) {
			bool s;
		...
		/// <summary>Returns the intersection point between the two lines. Lines are treated as infinite. start1 is returned if the lines are parallel</summary>
		public static Vector2 LineIntersectionPoint ([Bridge.Ref] Vector2 start1, [Bridge.Ref] Vector2 end1, [Bridge.Ref] Vector2 start2, [Bridge.Ref] Vector2 end2, out bool intersects) {
		...
		/// </summary>
		public static Vector3 SegmentIntersectionPointXZ ([Bridge.Ref] Vector3 start1, [Bridge.Ref] Vector3 end1, [Bridge.Ref] Vector3 start2, [Bridge.Ref] Vector3 end2, out bool intersects) {
			Vector3 dir1 = end1-start1;
			Vector3 dir2 = end2-start2;
		...
		/// </summary>
		public static bool SegmentIntersectsBounds ([Bridge.Ref] Bounds bounds, [Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b) {
		...
		/// </summary>
		public static float LineCircleIntersectionFactor ([Bridge.Ref] Vector3 circleCenter, [Bridge.Ref] Vector3 linePoint1, [Bridge.Ref] Vector3 linePoint2, float radius) {
			float segmentLength;
		...
		/// </summary>
		public static Vector3 Normalize ([Bridge.Ref] Vector3 v, out float magnitude) {
		...
		/// This is more efficient than calculating the magnitude and normalizing separately
		/// </summary>
		public static Vector2 Normalize ([Bridge.Ref] Vector2 v, out float magnitude) {
			magnitude = v.magnitude;
			// This is the same constant that Unity uses
			if (magnitude > 1E-05f) {
				return v / magnitude;
		...
		public static float MagnitudeXZ ([Bridge.Ref] Vector3 v) {
	...
	public static class Polygon {
		...
		/// </summary>
		public static bool ContainsPointXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c, [Bridge.Ref] Vector3 p) {
		...
		/// The triangle vertices are assumed to be laid out in clockwise order.
		/// </summary>
		public static bool ContainsPointXZ ([Bridge.Ref] Int3 a, [Bridge.Ref] Int3 b, [Bridge.Ref] Int3 c, [Bridge.Ref] Int3 p) {
		...
		/// The triangle vertices are assumed to be laid out in clockwise order.
		/// </summary>
		public static bool ContainsPoint ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b, [Bridge.Ref] Int2 c, [Bridge.Ref] Int2 p) {
		...
		/// </summary>
		public static bool ContainsPoint (Vector2[] polyPoints, [Bridge.Ref] Vector2 p) {
		...
		/// \author http://unifycommunity.com/wiki/index.php?title=PolyContainsPoint (Eric5h5)
		/// </summary>
		public static bool ContainsPointXZ (Vector3[] polyPoints, [Bridge.Ref] Vector3 p) {
			int j = polyPoints.Length-1;
			bool inside = false;
		...
		/// </summary>
		public static int SampleYCoordinateInTriangle ([Bridge.Ref] Int3 p1, [Bridge.Ref] Int3 p2, [Bridge.Ref] Int3 p3, [Bridge.Ref] Int3 p) {
		...
		/// </summary>
		public static Vector2 ClosestPointOnTriangle ([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b, [Bridge.Ref] Vector2 c, [Bridge.Ref] Vector2 p) {
		...
		/// See: 'Real Time Collision Detection' by Christer Ericson, chapter 5.1, page 141
		/// </summary>
		public static Vector3 ClosestPointOnTriangleXZ ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c, [Bridge.Ref] Vector3 p) {
			// Check if p is in vertex region outside A
		...
		/// See: 'Real Time Collision Detection' by Christer Ericson, chapter 5.1, page 141
		/// </summary>
		public static Vector3 ClosestPointOnTriangle ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c, [Bridge.Ref] Vector3 p) {
			// Check if p is in vertex region outside A
			var ab = b - a;
			var ac = c - a;
			var ap = p - a;
