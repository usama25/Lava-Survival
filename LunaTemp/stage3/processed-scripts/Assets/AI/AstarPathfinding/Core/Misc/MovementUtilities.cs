...
namespace Pathfinding.Util {
	public static class MovementUtilities {
		...
		public static Vector2 ClampVelocity ([Bridge.Ref] Vector2 velocity, float maxSpeed, float slowdownFactor, bool slowWhenNotFacingTarget, [Bridge.Ref] Vector2 forward) {
