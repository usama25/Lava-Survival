...
namespace Pathfinding {
	...
	public struct Int3 : System.IEquatable<Int3> {
		...
		public static float Angle ([Bridge.Ref] Int3 lhs, [Bridge.Ref] Int3 rhs) {
		...
		public static int Dot ([Bridge.Ref] Int3 lhs, [Bridge.Ref] Int3 rhs) {
			return
				lhs.x * rhs.x +
				lhs.y * rhs.y +
				lhs.z * rhs.z;
		...
		public static long DotLong ([Bridge.Ref] Int3 lhs, [Bridge.Ref] Int3 rhs) {
			return
		...
		public bool Equals ([Bridge.Ref] Int3 other) {
	...
	public struct Int2 : System.IEquatable<Int2> {
		...
		public static long DotLong ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b) {
		...
		public bool Equals ([Bridge.Ref] Int2 other) {
		...
		public static Int2 Min ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b) {
			return new Int2(System.Math.Min(a.x, b.x), System.Math.Min(a.y, b.y));
		}

		public static Int2 Max ([Bridge.Ref] Int2 a, [Bridge.Ref] Int2 b) {
			return new Int2(System.Math.Max(a.x, b.x), System.Math.Max(a.y, b.y));
		}

		public static Int2 FromInt3XZ ([Bridge.Ref] Int3 o) {
			return new Int2(o.x, o.z);
		}

		public static Int3 ToInt3XZ ([Bridge.Ref] Int2 o) {
