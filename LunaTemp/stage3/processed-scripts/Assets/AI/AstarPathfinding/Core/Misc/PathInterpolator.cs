...
namespace Pathfinding.Util {
	...
	public class PathInterpolator {
		...
		public void MoveToClosestPoint ([Bridge.Ref] Vector3 point) {
			if (path == null) return;
		...
		public void MoveToLocallyClosestPoint ([Bridge.Ref] Vector3 point, bool allowForwards = true, bool allowBackwards = true) {
			if (path == null) return;
		...
		public void MoveToCircleIntersection2D ([Bridge.Ref] Vector3 circleCenter3D, float radius, IMovementPlane transform) {
			if (path == null) return;
