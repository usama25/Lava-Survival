...
namespace Pathfinding {
	...
	public class AutoRepathPolicy {
		...
		public virtual bool ShouldRecalculatePath ([Bridge.Ref] Vector3 position, float radius, [Bridge.Ref] Vector3 destination) {
		...
		public virtual void DidRecalculatePath ([Bridge.Ref] Vector3 destination) {
		...
		public void DrawGizmos ([Bridge.Ref] Vector3 position, float radius) {
