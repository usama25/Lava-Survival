...
namespace Pathfinding.Util {
	public class GraphGizmoHelper : IAstarPooledObject, System.IDisposable {
		...
		public void Init (AstarPath active, [Bridge.Ref] RetainedGizmos.Hasher hasher, RetainedGizmos gizmos) {
			if (active != null) {
		...
		public void DrawWireTriangle ([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b, [Bridge.Ref] Vector3 c, [Bridge.Ref] Color color) {
