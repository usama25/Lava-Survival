...
namespace Pathfinding.Util {
	...
	public class RetainedGizmos {
		...
		public class Builder : IAstarPooledObject {
			...
			public void DrawWireCube (GraphTransform tr, [Bridge.Ref] Bounds bounds, [Bridge.Ref] Color color) {
				var min = bounds.min;
				var max = bounds.max;
			...
			public void DrawLine ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, [Bridge.Ref] Color color) {
				lines.Add(start);
				lines.Add(end);
			...
			public void Submit (RetainedGizmos gizmos, [Bridge.Ref] Hasher hasher) {
		...
		public GraphGizmoHelper GetGizmoHelper (AstarPath active, [Bridge.Ref] Hasher hasher) {
		...
		public bool HasCachedMesh ([Bridge.Ref] Hasher hasher) {
		...
		/// </summary>
		public bool Draw ([Bridge.Ref] Hasher hasher) {
