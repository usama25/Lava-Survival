...
namespace Pathfinding.Examples {
	...
	public class MecanimBridge : VersionedMonoBehaviour {
		...
		static Vector3 RotatePointAround ([Bridge.Ref] Vector3 point, [Bridge.Ref] Vector3 around, [Bridge.Ref] Quaternion rotation) {
		...
		protected virtual Quaternion RotateTowards ([Bridge.Ref] Vector3 direction, float maxDegrees) {
