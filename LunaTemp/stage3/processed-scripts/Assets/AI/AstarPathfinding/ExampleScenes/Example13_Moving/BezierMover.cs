...
namespace Pathfinding.Examples {
	...
	public class BezierMover : MonoBehaviour {
		...
		static void CatmullRomToBezier ([Bridge.Ref] Vector3 p0, [Bridge.Ref] Vector3 p1, [Bridge.Ref] Vector3 p2, [Bridge.Ref] Vector3 p3, out Vector3 c0, out Vector3 c1, out Vector3 c2, out Vector3 c3) {
			c0 = p1;
		...
		static Vector3 Curvature ([Bridge.Ref] Vector3 derivate, [Bridge.Ref] Vector3 secondDerivative) {
