...
namespace Pathfinding {
	...
	public class ConstantPath : Path {
		...
		public static ConstantPath Construct ([Bridge.Ref] Vector3 start, int maxGScore, OnPathDelegate callback = null) {
		...
		protected void Setup ([Bridge.Ref] Vector3 start, int maxGScore, OnPathDelegate callback) {
