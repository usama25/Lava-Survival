...
namespace Pathfinding {
	...
	public class FloodPathTracer : ABPath {
		...
		public static FloodPathTracer Construct ([Bridge.Ref] Vector3 start, FloodPath flood, OnPathDelegate callback = null) {
		...
		protected void Setup ([Bridge.Ref] Vector3 start, FloodPath flood, OnPathDelegate callback) {
			this.flood = flood;
