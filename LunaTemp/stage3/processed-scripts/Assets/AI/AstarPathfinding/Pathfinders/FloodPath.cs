...
namespace Pathfinding {
	...
	public class FloodPath : Path {
		...
		public static FloodPath Construct ([Bridge.Ref] Vector3 start, OnPathDelegate callback = null) {
		...
		protected void Setup ([Bridge.Ref] Vector3 start, OnPathDelegate callback) {
