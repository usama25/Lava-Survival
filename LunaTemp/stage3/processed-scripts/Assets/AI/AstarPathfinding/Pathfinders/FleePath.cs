...
namespace Pathfinding {
	...
	public class FleePath : RandomPath {
		...
		/// </summary>
		public static FleePath Construct ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 avoid, int searchLength, OnPathDelegate callback = null) {
		...
		protected void Setup ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 avoid, int searchLength, OnPathDelegate callback) {
