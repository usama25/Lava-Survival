...
namespace Pathfinding {
	...
	public class ABPath : Path {
		...
		/// </summary>
		public static ABPath Construct ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, OnPathDelegate callback = null) {
		...
		protected void Setup ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end, OnPathDelegate callbackDelegate) {
		...
		/// </summary>
		protected void UpdateStartEnd ([Bridge.Ref] Vector3 start, [Bridge.Ref] Vector3 end) {
		...
		/// </summary>
		[System.Obsolete()]
		public Vector3 GetMovementVector ([Bridge.Ref] Vector3 point) {
