...
namespace Pathfinding {
	...
	public class RandomPath : ABPath {
		...
		public static RandomPath Construct ([Bridge.Ref] Vector3 start, int length, OnPathDelegate callback = null) {
		...
		protected RandomPath Setup ([Bridge.Ref] Vector3 start, int length, OnPathDelegate callback) {
