...
namespace Pathfinding {
	...
	public class MultiTargetPath : ABPath {
		...
		public static MultiTargetPath Construct (Vector3[] startPoints, [Bridge.Ref] Vector3 target, OnPathDelegate[] callbackDelegates, OnPathDelegate callback = null) {
		...
		public static MultiTargetPath Construct ([Bridge.Ref] Vector3 start, Vector3[] targets, OnPathDelegate[] callbackDelegates, OnPathDelegate callback = null) {
		...
		protected void Setup ([Bridge.Ref] Vector3 start, Vector3[] targets, OnPathDelegate[] callbackDelegates, OnPathDelegate callback) {
			inverted = false;
